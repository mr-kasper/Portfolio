      ...
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          <div>
            ...
            <h1 className="text-bg text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-12 lg:leading-14 xl:leading-16 text-white">
              {BaseInfo.position}
            </h1>
            <p className="mt-6 text-sm md:text-base text-white/60">{BaseInfo.description}</p>
